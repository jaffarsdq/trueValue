...
const GetTopCustomersBasketAnalysis = () => {
    ...
    const conditionalRowStyles = [
        {
            when: (row) => row[Object.keys(row)[1]] === "Total values", // Apply styles when the first column value is "Total values"
            style: {
    ...
    const columns = useMemo(() => {
        ...
        const manualColumns = [
            ...
            {
                name: "Highest Bill Amount",
                columnName: "HighestBillAmount",
                selector: (row) => row["HighestBillAmount"],
                sortable: true,
                minWidth: "150px",
                right: true,
            },
...
export default GetTopCustomersBasketAnalysis;
